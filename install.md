...
```sh
curl -fLO https://github.com/koja-lang/koja/releases/download/v0.18.2/koja-v0.18.2-darwin-arm64.tar.gz
curl -fLO https://github.com/koja-lang/koja/releases/download/v0.18.2/koja-v0.18.2-darwin-arm64.tar.gz.sha256
shasum -a 256 -c koja-v0.18.2-darwin-arm64.tar.gz.sha256
tar -xzf koja-v0.18.2-darwin-arm64.tar.gz
mkdir -p ~/.local/bin
cp koja-v0.18.2-darwin-arm64/{koja,koja-lsp} ~/.local/bin/
```
